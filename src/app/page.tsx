...
const HomePage = () => {
  ...
  const themeImage = theme === 'usc' ? '/USC_hero.svg' : '/hero-devices.svg';
    ...
    <section className="flex flex-col items-center justify-center text-center mt-32">
      ...
      <div className="mb-8">
        <Image
          ...
          className="rounded-full border-4 border-gray-300 bg-primary" // Circular image styling
        />
      </div>
      
      {/* Additional Image */}
      <Image
        src={themeImage} // Update this path to your second image
        alt="Another Description"
        width={800} // Adjust size as needed
        height={500} // Adjust size as needed
         // Optional styling for the image
      />
       <div className="bg-primary text-white px-6 sm:px-12 md:px-24 lg:px-48 xl:px-64 2xl:px-80 py-16 sm:py-24 lg:py-32 shadow-lg">
...
<div className="flex justify-center mt-[-50px] mb-20">
  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-screen-xl w-full px-4 items-stretch">
    ...
    <div className="mb-4 w-[70px] h-[70px] rounded-full bg-tertiary flex items-center justify-center">
    <Image src='/software-eng.svg' alt="Logo 2" width={40} height={40} />
      ...
      <p className="text-primary text-center mt-8 font-semibold">Languages I speak:</p>
      <p className="text-gray-600 text-center mt-2">HTML, CSS, Git, JavaScript, TypeScript, Python, SQL, NoSQL, Bash</p>
      <p className="text-primary text-center mt-8 font-semibold">Dev Frameworks and Tools:</p>
      <div className="mt-2 text-left flex flex-col items-center space-y-2 text-gray-600">
        <p>Node.js</p>
        <p>React</p>
        <p>Angular</p>
        <p>NextJs</p>
    ...
    <Image src='/data-analysis.svg' alt="Logo 2" width={40} height={40} />
      ...
      <p className="text-primary text-center mt-8 font-semibold">Dev Tools and Frameworks:</p>
      <div className="mt-2 text-left flex flex-col items-center space-y-2 text-gray-600">
        <p>Apache Hadoop</p>
        <p>Apache Spark</p>
        <p>Airflow Kafka</p>
